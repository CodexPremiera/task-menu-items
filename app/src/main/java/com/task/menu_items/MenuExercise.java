...
public class MenuExercise extends AppCompatActivity {
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        if (item.getItemId() == R.id.mItemChange) Toast.makeText(this, "Change item clicked", Toast.LENGTH_SHORT).show();
            ...
            Drawable[] iconArray = {
                    getResources().getDrawable(R.drawable.icon_vector_heart),
                    getResources().getDrawable(R.drawable.icon_vector_home),
                    getResources().getDrawable(R.drawable.icon_vector_messenger)};
